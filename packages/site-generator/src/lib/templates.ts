...
const ALL_TEMPLATES: SiteTemplate[] = [
  {
    ...
    sectionOrder: ["hero", "services", "about", "gallery", "walkthrough", "pricing", "reviews", "booking", "faq", "contact", "blog"],
    baseColors: {
  ...
  },
  {
    ...
    sectionOrder: ["hero", "about", "gallery", "walkthrough", "services", "reviews", "team", "faq", "pricing", "contact", "blog"],
    baseColors: {
  ...
  },
  {
    ...
    sectionOrder: ["hero", "about", "services", "gallery", "walkthrough", "team", "reviews", "pricing", "faq", "blog", "contact"],
    baseColors: {
      surface: { h: 0, s: 0, l: 4 },
      ink: { h: 0, s: 0, l: 3 },
      text: { h: 0, s: 0, l: 96 },
  ...
  },
  {
    ...
    sectionOrder: ["hero", "services", "pricing", "gallery", "walkthrough", "about", "reviews", "booking", "faq", "blog", "contact"],
    baseColors: {
  ...
  },
  {
    ...
    sectionOrder: ["hero", "about", "services", "reviews", "gallery", "walkthrough", "pricing", "faq", "blog", "booking", "contact"],
    baseColors: {
